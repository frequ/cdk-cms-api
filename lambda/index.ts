...
export const handler = async (event: APIGatewayProxyEvent) => {
  ...
  const jsonResponse = {
    ...
    footer_note_html: `This <a target="_blank" href="${frontendUrl}">application</a> leverages the server-side rendering features of SvelteKit and uses This <a target="_blank" href="${cmsUrl}">AWS CDK built Lambda with API Gateway</a> as a content management system.`,
  };
